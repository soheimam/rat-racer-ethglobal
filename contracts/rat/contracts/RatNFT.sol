...
contract RatNFT is ERC721Enumerable, Ownable {
     ...
     */
    function mint(address to, string memory name, uint8 color) external returns (uint256) {
     ...
     */
    function getRatMetadata(uint256 tokenId) external view returns (RatMetadata memory) {
     ...
     */
    function getRatsOfOwner(address owner) external view returns (uint256[] memory) {
