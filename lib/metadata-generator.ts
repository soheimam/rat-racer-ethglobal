...
export function generateRatMetadata(
  ...
  const metadata: RatMetadata = {
    name,
    description: `A ${bloodline.name} racing rat from the underground streets. This rat has been bred for speed and competition.`,
    image: `https://rat-racer.vercel.app/images/rats/${color.toLowerCase()}-${modelIndex}.png`,
    external_url: `https://rat-racer.vercel.app/rat/${tokenId}`,
    attributes: [
      {
